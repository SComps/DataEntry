...
Imports System.Collections.Generic
    ...
    Public Class CodeGenerator
        ...
        Private Sub WriteMainForm(dir As String, ns As String, doc As DslDocument)
            ...
            sb.AppendLine("                Return")
            sb.AppendLine("            End If")
            sb.AppendLine("            ' Right Ctrl (alone) = Save.  When only Ctrl is held with no base key,")
            sb.AppendLine("            ' Terminal.Gui v2 fires KeyDown with e.IsCtrl=True and e.NoCtrl=Key.Empty.")
            sb.AppendLine("            ' Ctrl+S is accepted as a cross-platform fallback.")
            sb.AppendLine("            If e.IsCtrl AndAlso (e.NoCtrl = Key.Empty OrElse e.NoCtrl = Key.S) Then")
